...
| 2 | 支店コード | string | 255 | | o | | 1 | 指定した場合、営業員がその支店に所属している時のみ選択できます |
| 3 | 営業所コード | string | 255 | | o | | 1 | 指定した場合、営業員がその営業所に所属している時のみ選択できます |
| 4 | 納品先名 | string | 255 | |  | o | 横浜営業所 | |
| 5 | 郵便番号 | string | 255 |  |  | o | 227-0062| |
| 6 | 都道府県 | string | 255 |  |  | o | 神奈川県 | |
| 7 | 市区町村 | string | 255 |  |  | o | 横浜市青葉区 |  |
| 8 | 番地・号 | string | 255 |  |  | o | 1-2-3 | |
| 9 | 建物名 | string | 255 |  |  | | ABCビル | |
